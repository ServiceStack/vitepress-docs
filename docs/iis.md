...
::: info
Due to limitations in IIS 6 - host [ServiceStack at a /custompath](https://docs.servicestack.net/mvc-integration#enabling-servicestack-in-webconfig) which must end with `.ashx`, e.g: `path="api.ashx"`
:::
